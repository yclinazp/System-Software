...
#include <ctype.h>
// 
void generate(Tree *tree, char *asmFile) {      //  asmFile
  char nullVar[100]="";                                                             
  Generator *g = GenNew();                      //               
...
void GenPcodeToAsm(Generator *g, char* label, char* op, char* p1, char* p2, char* pTo) {   //
  ...
  if (strEqual(op, "=")) { // pTo = p1                                                     //                
    ...
    GenAsmCode(g, "", "LD", "R1", p1, "");                                                 //  LD R1, sum                  
    GenAsmCode(g, "", "LD", "R2", p2, "");                                                 //      LD R2, i                    
    GenAsmCode(g, "", asmOp,"R3", "R1", "R2");                                             //      ADD R3, R1, R2              
    GenAsmCode(g, "", "ST", "R3", pTo, "");                                                //      ST R3, sum                  
  } else if (strEqual(op, "CMP")) { // CMP p1, p2                                          //  CMP (cmp i 10)              
    GenAsmCode(g, "", "LD", "R1", p1, "");                                                 //  LD R1, i                    
